...
| [**Text Video Search**](./solutions/text_video_search)<br />Search for matched or related videos given an input text by Milvus and Towhee. | - [Jupyter notebook](solutions/text_video_search/1_text_video_retrieval_engine.ipynb)<br /> |
