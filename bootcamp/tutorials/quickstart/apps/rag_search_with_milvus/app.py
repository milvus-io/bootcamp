...
from milvus_utils import get_collection, get_milvus_client, get_search_results
from data_prep import get_text
...
collection_name, data = get_collection(milvus_client, text_lines, client)
...
with st.form("my_form"):
    ...
    if question and submitted:
        ...
        search_res = get_search_results(
            milvus_client, client, collection_name, question
        )
