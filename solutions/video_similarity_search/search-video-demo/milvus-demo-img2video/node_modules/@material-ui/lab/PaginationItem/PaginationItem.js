  ...
  return {
    ...
    outlinedPrimary: {
      '&$selected': {
        ...
        backgroundColor: (0, _styles.fade)(theme.palette.primary.main, theme.palette.action.activatedOpaciy),
        '&:hover, &$focusVisible': {
          backgroundColor: (0, _styles.fade)(theme.palette.primary.main, theme.palette.action.activatedOpaciy + theme.palette.action.hoverOpacity),
          // Reset on touch devices, it doesn't add specificity
          '@media (hover: none)': {
            backgroundColor: 'transparent'
          }
    ...
    outlinedSecondary: {
      '&$selected': {
        ...
        backgroundColor: (0, _styles.fade)(theme.palette.secondary.main, theme.palette.action.activatedOpaciy),
        '&:hover, &$focusVisible': {
          backgroundColor: (0, _styles.fade)(theme.palette.secondary.main, theme.palette.action.activatedOpaciy + theme.palette.action.hoverOpacity),
          // Reset on touch devices, it doesn't add specificity
          '@media (hover: none)': {
            backgroundColor: 'transparent'
          }
...
var PaginationItem = _react.default.forwardRef(function PaginationItem(props, ref) {
  ...
  return type === 'start-ellipsis' || type === 'end-ellipsis' ? _react.default.createElement("div", {
    ref: ref,
  ...
  }, "\u2026") : _react.default.createElement(_ButtonBase.default, (0, _extends2.default)({
    ref: ref,
    component: component,
    disabled: disabled,
  ...
  }, other), type === 'page' && page, type === 'previous' && _react.default.createElement(_NavigateBefore.default, {
    className: classes.icon
  }), type === 'next' && _react.default.createElement(_NavigateNext.default, {
    className: classes.icon
  }), type === 'first' && _react.default.createElement(_FirstPage.default, {
    className: classes.icon
  }), type === 'last' && _react.default.createElement(_LastPage.default, {
    className: classes.icon
  }));
});
