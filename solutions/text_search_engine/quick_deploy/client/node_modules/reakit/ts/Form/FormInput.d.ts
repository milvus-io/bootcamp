...
export declare type unstable_FormInputOptions<V, P extends DeepPath<V, P>> = TabbableOptions & Pick<unstable_FormStateReturn<V>, "baseId" | "values" | "touched" | "errors" | "update" | "blur"> & {
    /**
