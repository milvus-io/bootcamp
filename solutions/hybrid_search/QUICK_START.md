...
- `src/mixed_import.py` for importing data into Milvus and PostgreSQL.
- `src/mixed_query.py` for executing customized hybrid search.
...
```shell
python3 src/mixed_query.py -n 0 -s male -t '[2019-05-01 00:00:00, 2019-07-12 00:00:00]' -q
```
...
```shell
python3 src/mixed_query.py -n 20 -s female -g False
```
...
```shell
python3 src/mixed_query.py -n 100 -s female -g True -t '[2019-05-01 15:15:05, 2019-07-30 11:00:00]' -q
```

To search the vector based on the vector id:

```shell
python3 src/mixed_query.py -v 237434787867
```
