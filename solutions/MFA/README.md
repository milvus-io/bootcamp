...
> 注意：在构建镜像时需下载 face_embedding模型，下载链接：https://pan.baidu.com/s/18EWcP5YJmeDrY1A8_k09pw , 提取码：82ht
>
> 下载完成后请将该 models 文件夹移动到 bootcamp/solutions/MFA/webserver/face-embedding 下。
