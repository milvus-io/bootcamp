...
| Memory   | 32GB                                                         |
| OS       | Ubuntu 18.04                                                 |
| Software | Milvus 0.7.0 pic_search_webclient pic_search_webserver |
...
This demo uses GPU-supported Milvus 0.7.0. Refer to the [Install Milvus](https://github.com/milvus-io/docs/blob/v0.7.0/site/zh-CN/guides/get_started/install_milvus/install_milvus.md) for how to run Milvus docker.
